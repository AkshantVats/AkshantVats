...
|---|---:|---:|---:|---:|---|
| [infra-ai-streaming](https://github.com/AkshantVats/infra-ai-streaming) | 0 | 0 | 3 | 11h ago | [`392c723`](https://github.com/AkshantVats/infra-ai-streaming/commit/392c7239a74189d11653af777975dfd9560c98d0) feat(oss-03): add OpenTelemetry Collector integration for LensAI ingest (#64) |
...
| [Profile](https://github.com/AkshantVats/Profile) | 1 | 0 | 0 | 11h ago | [`cbac9f0`](https://github.com/AkshantVats/Profile/commit/cbac9f045b3522876f247557c638b19931808483) Day 31: OpenTelemetry Semantics for Agents (AI Learning) |
<!-- LIVE_REPO_PULSE:END -->
...
- `11h ago` merged PR [pull request in AkshantVats/Profile](https://github.com/AkshantVats/Profile)
