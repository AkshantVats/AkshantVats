...
|---|---:|---:|---:|---:|---|
| [infra-ai-streaming](https://github.com/AkshantVats/infra-ai-streaming) | 0 | 0 | 4 | 19h ago | [`6e22bf6`](https://github.com/AkshantVats/infra-ai-streaming/commit/6e22bf6d2a8fb97d30163aa86d93224ff6afdaf4) docs: add OTel Gen AI semconv surface to OBSERVABILITY.md (#58) |
...
- `19h ago` opened PR [pull request in AkshantVats/infra-ai-streaming](https://github.com/AkshantVats/infra-ai-streaming)
- `19h ago` pushed to [AkshantVats/infra-ai-streaming](https://github.com/AkshantVats/infra-ai-streaming): pushed commits
- `19h ago` created branch in [AkshantVats/infra-ai-streaming](https://github.com/AkshantVats/infra-ai-streaming)
